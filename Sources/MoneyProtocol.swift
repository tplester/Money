...
public extension MoneyProtocol {
    ...
    var integerValue: Int {
        return Int(amount.doubleValue.rounded(.toNearestOrEven))
    }
    ...
    var minorUnits: Int {
        return Int((decimal.multiplying(byPowersOf10: Int16(currency.scale)) as NSDecimalNumber).doubleValue.rounded(.toNearestOrEven))
    }
